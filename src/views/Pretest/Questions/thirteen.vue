<template>
  <div class="pb-1 px-10">
    <div class="d-flex flex-column">
      <p class="text-h5">Pertanyaan 13</p>
      <p class="text-h6 font-weight-regular">Gejala vegetatif</p>
      ...
      <div class="my-6 checkbox-container">
        <div
          ...
          :class="{ selected: answer.question13 == 1 }"
        >
          <v-checkbox
            v-model="answer.question13"
            :value="1"
            hide-details
            color="secondary"
          >
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question13 == 2 }"
        >
          <v-checkbox
            v-model="answer.question13"
            :value="2"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question13 == 3 }"
        >
          <v-checkbox
            v-model="answer.question13"
            :value="3"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question13 == 4 }"
        >
          <v-checkbox
            v-model="answer.question13"
            :value="4"
