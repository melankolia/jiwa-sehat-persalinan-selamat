<template>
  <div class="pb-1 px-10">
    <div class="d-flex flex-column">
      ...
      <p class="text-h6 font-weight-regular">Gangguan Tidur</p>
      ...
      <div class="my-6 checkbox-container">
        <div
          ...
          :class="{ selected: answer.question4 == 1 }"
        >
          <v-checkbox
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question4 == 2 }"
        >
          <v-checkbox
            v-model="answer.question4"
            :value="2"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question4 == 3 }"
        >
          <v-checkbox
            v-model="answer.question4"
            :value="3"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question4 == 4 }"
        >
          <v-checkbox
            v-model="answer.question4"
            :value="4"
