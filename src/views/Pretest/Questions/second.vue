<template>
  <div class="pb-1 px-10">
    <div class="d-flex flex-column">
      ...
      <p class="text-h6 font-weight-regular">Ketegangan</p>
      <p class="text-body-1 font-weight-regular">
        Perasaan tegang, respon kaget, gemetar, mudah menangis, perasaan
        gelisah, ketidakmampuan untuk bersantai.
      </p>
      <div class="my-6 checkbox-container">
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question2 == 0 }"
        >
          <v-checkbox
            v-model="answer.question2"
            :value="'0'"
            hide-details
            color="secondary"
          >
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question2 == 2 }"
        >
          <v-checkbox
            v-model="answer.question2"
            hide-details
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question2 == 3 }"
        >
          <v-checkbox
            v-model="answer.question2"
            hide-details
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question2 == 4 }"
        >
          <v-checkbox
            v-model="answer.question2"
            hide-details
