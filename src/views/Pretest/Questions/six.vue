<template>
  <div class="pb-1 px-10">
    <div class="d-flex flex-column">
      <p class="text-h5">Pertanyaan 6</p>
      <p class="text-h6 font-weight-regular">Perasaan depresi</p>
      <p class="text-body-1 font-weight-regular">
        Hilangnya minat, berkurangnya kesenangan pada hobi, sedih, perasaan
        tidak menyenangkan sepanjang hari, bangun awal.
      </p>
      <div class="my-2 checkbox-container">
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question6 == 1 }"
        >
          <v-checkbox
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question6 == 2 }"
        >
          <v-checkbox
            v-model="answer.question6"
            :value="2"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question6 == 3 }"
        >
          <v-checkbox
            v-model="answer.question6"
            :value="3"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question6 == 4 }"
        >
          <v-checkbox
            v-model="answer.question6"
            :value="4"
