...
export default {
  ...
  computed: {
    dialogDescription() {
      return "Setelah ibu membaca informasi seputar kehamilan, silahkan mempelajari dan mempraktikkan teknik mengatasi cemas berikut ini";
    },
  },
};
</script>
