<template>
  <div class="pb-1 px-10">
    <div class="d-flex flex-column">
      <p class="text-h5">Pertanyaan 9</p>
      <p class="text-h6 font-weight-regular">Gejala kardiovaskular</p>
      ...
      <div class="my-6 checkbox-container">
        <div
          ...
          :class="{ selected: answer.question9 == 0 }"
        >
          <v-checkbox
            v-model="answer.question9"
            :value="'0'"
            hide-details
            color="secondary"
          >
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question9 == 1 }"
        >
          <v-checkbox
            v-model="answer.question9"
            :value="1"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question9 == 2 }"
        >
          <v-checkbox
            v-model="answer.question9"
            :value="2"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question9 == 3 }"
        >
          <v-checkbox
            v-model="answer.question9"
            :value="3"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question9 == 4 }"
        >
          <v-checkbox
            v-model="answer.question9"
            :value="4"
