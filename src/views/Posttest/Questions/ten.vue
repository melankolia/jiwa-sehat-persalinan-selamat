    ...
    <div class="d-flex flex-column">
      ...
      <div class="my-6 checkbox-container">
        <div
          ...
          :class="{ selected: answer.question10 == 0 }"
        >
          <v-checkbox
            v-model="answer.question10"
            :value="'0'"
            hide-details
            color="secondary"
          >
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question10 == 1 }"
        >
          <v-checkbox
            v-model="answer.question10"
            :value="1"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question10 == 2 }"
        >
          <v-checkbox
            v-model="answer.question10"
            :value="2"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question10 == 3 }"
        >
          <v-checkbox
            v-model="answer.question10"
            :value="3"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question10 == 4 }"
        >
          <v-checkbox
            v-model="answer.question10"
            :value="4"
