    ...
    <div class="d-flex flex-column">
      ...
      <div class="my-6 checkbox-container">
        <div
          ...
          :class="{ selected: answer.question14 == 1 }"
        >
          <v-checkbox
            v-model="answer.question14"
            :value="1"
            hide-details
            color="secondary"
          >
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question14 == 2 }"
        >
          <v-checkbox
            v-model="answer.question14"
            :value="2"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question14 == 3 }"
        >
          <v-checkbox
            v-model="answer.question14"
            :value="3"
        ...
        <div
          class="d-flex flex-column justify-center background-div px-4 py-5"
          :class="{ selected: answer.question14 == 4 }"
        >
          <v-checkbox
            v-model="answer.question14"
            :value="4"
